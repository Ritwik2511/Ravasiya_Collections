  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: SafeArea(
          ...
          builder: (toyDetailScreenController) => GetBuilder<CartControllerNew>(
  ...
  applyCoupon(var controller, {bool isFirst = false}) async {
    ...
    if (validate) {
      if (couponCodeController.text.isNotEmpty) {
        ...
        productController.isApplyCouponProcess.value = true;
        ...
        if (promoPrice > 0.0) {
          ...
          productController.isApplyCouponProcess.value = false;
        } else {
          // context.loaderOverlay.hide();
          productController.isApplyCouponProcess.value = false;
        }
